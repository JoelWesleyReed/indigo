...
#define JOYSTICK_MAPPING_FOCUS_IN_ITEM_NAME						"FOCUS_IN"
#define JOYSTICK_MAPPING_FOCUS_OUT_ITEM_NAME					"FOCUS_OUT"
...
#define AUX_DEW_CONTROL_AUTOMATIC_AGGRESSIVENESS_NAME			"AUX_HEATER_AGGRESSIVENESS"
